...
import cn.org.sprouts.demo.security.spring.filter.MyAccessDecisionManager;
import cn.org.sprouts.demo.security.spring.filter.MyReauthenticationManager;
import cn.org.sprouts.demo.security.spring.filter.MyFilterInvocationSecurityMetadataSource;
import cn.org.sprouts.demo.security.spring.filter.MySecurityInterceptor;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private MySecurityInterceptor mySecurityInterceptorFilter;
    ...
    public MySecurityInterceptor mySecurityInterceptorFilter(final MyFilterInvocationSecurityMetadataSource myFilterInvocationSecurityMetadataSource,
            final MyAccessDecisionManager myAccessDecisionManager,
            final MyReauthenticationManager myAuthenticationManager) {
        return new MySecurityInterceptor(myFilterInvocationSecurityMetadataSource, myAccessDecisionManager, myAuthenticationManager);
    }
    ...
    public FilterRegistrationBean myAuthenticationFilterRegistration(final MySecurityInterceptor mySecurityInterceptorFilter) {
